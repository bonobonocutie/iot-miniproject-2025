...
namespace WpfMrpSimulatorApp.ViewModels
{
    public partial class MonitoringViewModel : ObservableObject
    {
        ...
        private string mqttSubTopic; // MQTT 메세지 받아올때 쓰는 토픽
        private string mqttPubTopic; // MQTT 메세지 보낼떄 쓰는 토픽
        ...
        public MonitoringViewModel(IDialogCoordinator coordinator)
        {
            ...
            // MQTT 초기화
            brokerHost = "210.119.12.73"; // 본인 아이피
            clientId = "MON01";
            mqttSubTopic = "pknu/sf73/data";
            mqttPubTopic = "pknu/sf73/control";
        ...
        public async Task SearchProcess()
        {
            ...
            {
                await this.dialogCoordinator.ShowMessageAsync(this, "오류", "오류");
            }
        }
