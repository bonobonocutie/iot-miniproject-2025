...
namespace WpfMqttSubApp.ViewModels
{
    public partial class MainViewModel : ObservableObject, IDisposable
    {
        ...
        public MainViewModel(IDialogCoordinator coordinator)
        {
            ...
            BrokerHost = App.Configuration.Mqtt.Broker; //"210.119.12.73";
            DatabaseHost = App.Configuration.Database.Server; //"210.119.12.73";
            mqttTopic = App.Configuration.Mqtt.Topic; //"pknu/sf73/data"; // 설정파일로 작업가능
